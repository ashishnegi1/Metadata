...
const mintData = await getMint(connection, mintAddress, undefined, TOKEN_2022_PROGRAM_ID);
...
console.log(mintMetadata === null || mintMetadata === void 0 ? void 0 : mintMetadata.name);
const tokenAccount = await getOrCreateAssociatedTokenAccount(connection, owner, mintAddress, owner.publicKey, undefined, undefined, undefined, TOKEN_2022_PROGRAM_ID);
console.log("Token account address : ");
console.log(tokenAccount.address.toBase58());
await mintTo(connection, owner, mintAddress, tokenAccount.address, owner.publicKey, 1000000000, undefined, undefined, TOKEN_2022_PROGRAM_ID);
const mintInfo = await getMint(connection, mintAddress, undefined, TOKEN_2022_PROGRAM_ID);
console.log("Mint data(new supply) : ");
console.log(mintInfo.supply);
const tokenAccountInfo = await getAccount(connection, tokenAccount.address, undefined, TOKEN_2022_PROGRAM_ID);
